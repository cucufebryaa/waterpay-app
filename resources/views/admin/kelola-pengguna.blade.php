...
@section('title', 'Manajemen Pelanggan - Admin WaterPay')
    ...
    <div class="row g-3 my-2">
        <div class="col-12">
            <div class="p-3 bg-white shadow-sm rounded-3 text-center">
                <h3 class="fw-bold mb-0 text-primary">MANAJEMEN DATA PELANGGAN</h3>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="p-4 bg-white shadow-sm rounded-3">
                ...
                <div class="d-flex justify-content-end mb-4">
                    <button type="button" class="btn btn-success shadow-sm" data-bs-toggle="modal" data-bs-target="#modalTambahPelanggan">
...
{{-- 
==================================================================================
MODAL 1: TAMBAH Pelanggan (CREATE)
==================================================================================
--}}
        ...
        <div class="modal-content shadow-lg border-0 rounded-3">
            ...
            <form action="{{ route('admin.pelanggan.store') }}" method="POST" class="needs-validation" novalidate>
                ...
                <div class="modal-header bg-success text-white p-4">
                    <h5 class="modal-title" id="modalTambahPelangganLabel"><i class="bi bi-person-plus-fill me-2"></i>Form Tambah Pelanggan Baru</h5>
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <h6 class="text-muted border-bottom pb-2 mb-3">Informasi Pelanggan</h6>
                            <div class="mb-3">
                                <label for="nama" class="form-label fw-bold">Nama Lengkap pelanggan <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" placeholder="Pelanggan@email.com" required>
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('username') is-invalid @enderror" id="username" name="username" value="{{ old('username') }}" placeholder="Pelanggan_unik_123" required>
                                @error('username')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
        ...
        <div class="modal-content shadow-lg border-0 rounded-3">
            ...
            <form action="" method="POST" id="formEditPelanggan" class="needs-validation" novalidate>
                ...
                <div class="modal-header bg-warning text-dark p-4">
                    <h5 class="modal-title" id="modalEditPelangganLabel"><i class="bi bi-pencil-square me-2"></i>Form Edit Pelanggan</h5>
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <h6 class="text-muted border-bottom pb-2 mb-3">Informasi Pelanggan</h6>
                            <div class="mb-3">
                                <label for="edit_nama" class="form-label fw-bold">Nama Lengkap Pelanggan <span class="text-danger">*</span></label>
...
<script>
    ...
    function showDetailAlert(pelangganData) {
        ...
        // Objek untuk kolom kiri (Info Pelanggan)
        const detailPelanggan = {
            'Nama Lengkap': pelangganData.nama,
            'Alamat': pelangganData.alamat,
            'No. Handphone': pelangganData.no_hp,
            'ID Pelanggan': pelangganData.id,
            'ID Perusahaan': pelangganData.id_company
        };
        
        // Objek untuk kolom kanan (Info Akun)
        const detailUser = {};
        if (pelangganData.user) {
            detailUser['Username'] = pelangganData.user.username;
            detailUser['Email'] = pelangganData.user.email;
            detailUser['NIK'] = pelangganData.user.nik;
            detailUser['ID User'] = pelangganData.user.id;
        } else {
        ...
        let htmlContent = `
            <div class="detail-popup-content">
                <div class="detail-popup-column">
                    <div class="info-card">
                        <h5 class="mb-3"><i class="bi bi-person-badge me-2"></i>Info Pelanggan</h5>
        ...
        Swal.fire({
            title: `<i class="bi bi-person-vcard me-2"></i> Detail: ${pelangganData.nama}`,
            html: htmlContent,
    ...
    function showDeleteAlert(pelangganId, pelangganName) {
        Swal.fire({
            ...
            text: `Anda yakin ingin menghapus "${pelangganName}"? Tindakan ini tidak dapat dibatalkan!`,
