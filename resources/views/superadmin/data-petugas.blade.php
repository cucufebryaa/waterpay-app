    ...
    <div class="row g-3 my-2">
        <div class="col-12">
            <div class="dashboard-card py-3 px-4 text-center">
                <h5 class="fw-bold mb-0">TABEL DATA PETUGAS</h5>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="p-4 bg-white shadow-sm rounded-3">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <form method="GET" action="{{ route('superadmin.data-petugas') }}" class="d-flex w-50 me-auto">
                    ...
                    <a href="#" class="btn btn-primary">+ Petugas</a>
                </div>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a href="{{ route('superadmin.petugas.login-as', $p->id) }}" class="btn btn-sm btn-success me-2" title="Login Langsung">
